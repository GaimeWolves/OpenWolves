...
public class OBJLoader {
	...
	/**
	 * loads a OBJ file and converts it into a model object holding the vertices, UV coordinates, normals and indices
	 ...
	 */
    private static void processVertex(String[] vertexData, List<Integer> indices, List<Vector2f> textures, List<Vector3f> normals, float[] uvArray, float[] normalsArray) {
