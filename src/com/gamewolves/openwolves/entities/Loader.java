...
public class Loader
{
	...
	/**
	 * Creates a VAO holding the values: 1. Vertices
	 * 
	...
	/**
	 * Creates a VAO holding the values: 1. Vertices 2. Indices
	 * 
	 * @param vertices Vertices as a float array { x1, y1, z1, x2, y2, ... }
	...
	/**
	 * Creates a VAO holding the values: 1. Vertices 2. Indices 3. Texture
	 * coordinates
	 * 
	 * @param vertices Vertices as a float array { x1, y1, z1, x2, y2, ... }
	 * @param indices Indices as an integer array
	...
	/**
	 * Creates a VAO holding the values: 1. Vertices 2. Indices 3. Normals
	 * 
	 * @param vertices Vertices as a float array { x1, y1, z1, x2, y2, ... }
	 * @param indices Indices as an integer array
	 * @param normals Normals as a float array
	...
	/**
	 * Creates a VAO holding vertex data and other attributes
	 * 
	 * @param vertices The vertices of the VAO
	 * @param attributes The attributes of the VAO
	 * @param attributeSizes The coordinate size of the attributes
	 * @return The index of the VAO
	 */
	public static int loadVAO_V_ANY(float[] vertices, float[][] attributes, int[] attributeSizes)
	{
		int vaoID = createVAO();
		...
		{
			storeDataInVBO(i + 1, attributes[i], attributeSizes[i], vaoID);
		}
