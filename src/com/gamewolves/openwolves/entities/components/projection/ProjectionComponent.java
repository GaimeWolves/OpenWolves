...
public class ProjectionComponent extends Component {
	...
	/**
	 * Constructs the projection matrix from the field of view, the aspect ration, the near clip plane and the far clip plane
	 */
	...
	/**
	 * Calculates a new projection matrix from the field of view, the aspect ration, the near clip plane and the far clip plane
